      ...
      <div className="md:col-span-4">
        ...
        <div className="mt-4 md:mt-24">
             <img 
                ...
                src="https://images.unsplash.com/photo-1465311440653-ba9bb029dabf?q=80&w=800&auto=format&fit=crop" 
                alt="Rider looking at landscape" 
                className="w-full h-auto object-cover grayscale opacity-70 trax-image hidden md:block"
            />
