...
export const Footer: React.FC = () => {
  ...
  const handleJoinClick = () => {
    const url = 'https://chat.whatsapp.com/IYnaKYKJsS2DgMljmyMRWD';
  ...
  return (
    <footer id="footer" className="relative pt-32 pb-12 border-t border-trax-grey/10 bg-trax-black overflow-hidden">
      {/* Background image */}
      <div
      ...
      <div className="relative z-10">
        <Container className="text-center mb-32">
          ...
          <Button className="mb-16" onClick={handleJoinClick}>
            Join when ready
          </Button>
          ...
          <div className="flex justify-center items-center gap-6 md:gap-10 mb-16">
            <a
              ...
              href="https://www.youtube.com/@ridetrax"
              aria-label="Visit TRAX on YouTube (opens in new tab)"
            ...
            <a
              target="_blank"
              rel="noopener noreferrer"
              href="https://www.instagram.com/ridetrax"
              aria-label="Visit TRAX on Instagram (opens in new tab)"
            ...
            <a
              target="_blank"
              rel="noopener noreferrer"
              href="https://www.facebook.com/share/1DeGDZW2sc/?mibextid=wwXIfr"
              aria-label="Visit TRAX on Facebook (opens in new tab)"
        ...
        <Container>
          <div className="flex flex-col md:flex-row justify-between items-end border-t border-trax-grey/20 pt-8">
            <div className="mb-6 md:mb-0">
              <h2 className="font-sans text-2xl font-bold tracking-widest text-trax-white">TRAX</h2>
