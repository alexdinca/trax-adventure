...
import type { LatLng, RouteWaypoint } from '@/app/briefing/carpathian-ridge/briefing-data';
...
export default function CarpathianRidgeMap({ route, waypoints }: Props) {
  ...
  useEffect(() => {
    ...
    waypoints.forEach((wpt) => {
      if (wpt.type === 'fuel' || wpt.type === 'lunch') {
