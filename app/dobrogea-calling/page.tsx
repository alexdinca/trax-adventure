...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: 'Join a 650km adventure across ancient Romanian terrain. 3 days, 12 points of interest, shared discovery.',
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
              {[
                ...
                { label: 'Distance', value: '650km', sub: 'Off-Road Exploration' },
