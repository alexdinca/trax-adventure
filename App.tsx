...
function App() {
  ...
  return (
    <div className="bg-trax-black min-h-screen w-full selection:bg-trax-red selection:text-trax-white relative overflow-x-hidden">
      
      {/* Global Background Watermark */}
      <div className="fixed inset-0 z-0 flex items-center justify-center pointer-events-none opacity-[0.06]">
          <img 
              src="/trax-tyre-mark.png" 
              alt="" 
              className="w-[90vw] md:w-[600px] object-contain max-h-[80vh]"
          />
      </div>
